...
CONSUMER_LOG_FILE_PATH = os.path.join(BASEDIR, "application/logs/consumer_logs.txt")

PRODUCER_LOG_FILE_PATH = os.path.join(BASEDIR, 'application/logs/producer_log.txt')
